...
from srt.modules.selenium_version import get_selenium_version
...
# driver.find_element(
#     By.XPATH,
#     "/html/body/div/div[4]/div/div[2]/form/\
#     fieldset/div[1]/div[1]/div[2]/div/div[2]/input",
# ).click()
...
# train_list = driver.find_elements(
#     By.CSS_SELECTOR,
...
#             standard_seat = driver.find_element(
#                 By.CSS_SELECTOR,
...
#                 driver.find_element(
#                     By.XPATH,
#                     f"/html/body/div[1]/div[4]/div/div[3]/div[1]/\
#                 form/fieldset/div[6]/table/tbody/tr[{i}]/td[7]/a/span",
#                 ).click()
...
#                     # 메시지 전송
#                     response = slack_noti.post_message(token, channel_id, msg)
...
#                 By.XPATH, "/html/body/div/div[4]/div/div[2]/form/fieldset/div[2]/input"
#             )
